...
class TestGameStatePopOutCheckWinner {
    ...
    fun testIdentifiesTie() {
        ...
        b.drop(4)
        b.drop(5)
        Assertions.assertEquals(Pair(true, Players.NONE), b.checkWinner())
    }

    @Test
    fun testDoesNotIdentifyTieForPopOutMode() {
        val b = GameState(6, 5, popOut = true)
        b.drop(0)
        b.drop(2)
        b.drop(1)
        b.drop(3)
